 ...
 * Usage:
 * 
 * int sampleInt = NormAppPreferencesEnum.getInstance(context).getInt(Key.SAMPLE_INT);
 * NormAppPreferencesEnum.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 * 
 * If NormAppPreferencesEnum.getInstance(Context) has been called once, you can 
 * simple use NormAppPreferencesEnum.getInstance() to save some precious line space.
 */
public class NormAppPreferencesEnum {
private static final String SETTINGS_NAME = "default_settings";
private static NormAppPreferencesEnum sSharedPrefs;
...
private NormAppPreferencesEnum(Context context) {
        mPref = context.getSharedPreferences(SETTINGS_NAME, Context.MODE_PRIVATE);
        }


public static NormAppPreferencesEnum getInstance(Context context) {
        if (sSharedPrefs == null) {
        sSharedPrefs = new NormAppPreferencesEnum(context.getApplicationContext());
        }
        return sSharedPrefs;
        }

public static NormAppPreferencesEnum getInstance() {
        if (sSharedPrefs != null) {
        return sSharedPrefs;
        }
